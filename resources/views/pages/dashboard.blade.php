            ...
            <aside id="application-sidebar-brand"
                        ...
                        <ul id="sidebarnav" class="text-gray-600 text-sm">
                            ...
                            <li class="sidebar-item">
                                <a class="sidebar-link gap-3 py-2.5 my-1 text-base flex items-center justify-between relative rounded-md text-gray-500 w-full"
                                    ...
                                    <span
                                        class="text-white bg-blue-700 rounded-3xl px-2 text-xs py-0.5 mr-5">Pro</span>
                                </a>
                            </li>
                            ...
                            <div class="hs-accordion-group">
                                <div class="hs-accordion sidebar-item"
                                    ...
                                    <div id="hs-basic-with-title-and-arrow-stretched-collapse-ecommerce"
                                        ...
                                        <a class="gap-4 py-2.5 my-1 px-[14px] text-sm flex items-center justify-between relative  rounded-md text-gray-500  w-full"
                                            target="_blank"
                                            href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/eco-shop.html">
                                            <div class="flex items-center gap-4">
                                                <i class="ti ti-circle text-xs"></i> <span>Shop One</span>
                                            </div>
                                            <span
                                                class="text-white bg-blue-700 rounded-3xl px-2 text-xs py-0.5">Pro</span>
                                        </a>
                                        <a class="gap-4 py-2.5 my-1 px-[14px] text-sm flex items-center justify-between relative  rounded-md text-gray-500  w-full"
                                            target="_blank"
                                            href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/eco-shop2.html">
                                            <div class="flex items-center gap-4">
                                        ...
                                        <a class="gap-4 py-2.5 my-1 px-[14px] text-sm flex items-center justify-between relative  rounded-md text-gray-500  w-full"
                                            target="_blank"
                                            href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/eco-shop-detail.html">
                                            <div class="flex items-center gap-4">
                                        ...
                                        <a class="gap-4 py-2.5 my-1 px-[14px] text-sm flex items-center justify-between relative  rounded-md text-gray-500  w-full"
                                            target="_blank"
                                            href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/eco-shop-detail2.html">
                                            <div class="flex items-center gap-4">
                                        ...
                                        <a class="gap-4 py-2.5 my-1 px-[14px] text-sm flex items-center justify-between relative  rounded-md text-gray-500  w-full"
                                            target="_blank"
                                            href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/eco-product-list.html">
                                            <div class="flex items-center gap-4">
                                        ...
                                        <a class="gap-4 py-2.5 my-1 px-[14px] text-sm flex items-center justify-between relative  rounded-md text-gray-500  w-full"
                                            target="_blank"
                                            href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/eco-checkout.html">
                                            <div class="flex items-center gap-4">
                            ...
                            <div class="hs-accordion-group">
                                <div class="hs-accordion sidebar-item"
                                    ...
                                    <div id="hs-basic-with-title-and-arrow-stretched-collapse-userprofile"
                                        ...
                                        <a class="gap-4 py-2.5 my-1 px-[14px] text-sm flex items-center justify-between relative  rounded-md text-gray-500  w-full"
                                            target="_blank"
                                            href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/page-user-profile.html">
                                            <div class="flex items-center gap-4">
                                        ...
                                        <a class="gap-4 py-2.5 my-1 px-[14px] text-sm flex items-center justify-between relative  rounded-md text-gray-500  w-full"
                                            target="_blank"
                                            href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/page-user-profile2.html">
                                            <div class="flex items-center gap-4">
                            ...
                            <div class="hs-accordion-group">
                                <div class="hs-accordion sidebar-item"
                                    ...
                                    <div id="hs-basic-with-title-and-arrow-stretched-collapse-blog"
                                        ...
                                        <a class="gap-4 py-2.5 my-1 px-[14px] text-sm flex items-center justify-between relative  rounded-md text-gray-500  w-full"
                                            target="_blank"
                                            href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/blog-posts.html">
                                            <div class="flex items-center gap-4">
                                        ...
                                        <a class="gap-4 py-2.5 my-1 px-[14px] text-sm flex items-center justify-between relative  rounded-md text-gray-500  w-full"
                                            target="_blank"
                                            href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/blog-detail.html">
                                            <div class="flex items-center gap-4">
                            ...
                            <li class="sidebar-item">
                                <a class="sidebar-link gap-3 py-2.5 my-1 text-base flex items-center justify-between relative rounded-md text-gray-500 w-full"
                                    target="_blank"
                                    href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/app-email.html">
                                    <div class="flex items-center gap-2">
                            ...
                            <li class="sidebar-item">
                                <a class="sidebar-link gap-3 py-2.5 my-1 text-base flex items-center justify-between relative rounded-md text-gray-500 w-full"
                                    target="_blank"
                                    href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/app-calendar.html">
                                    <div class="flex items-center gap-2">
                            ...
                            <li class="sidebar-item">
                                <a class="sidebar-link gap-3 py-2.5 my-1 text-base flex items-center justify-between relative rounded-md text-gray-500 w-full"
                                    target="_blank"
                                    href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/app-kanban.html">
                                    <div class="flex items-center gap-2">
                            ...
                            <li class="sidebar-item">
                                <a class="sidebar-link gap-3 py-2.5 my-1 text-base flex items-center justify-between relative rounded-md text-gray-500 w-full"
                                    target="_blank"
                                    href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/app-chat.html">
                                    <div class="flex items-center gap-2">
                            ...
                            <li class="sidebar-item">
                                <a class="sidebar-link gap-3 py-2.5 my-1 text-base flex items-center justify-between relative rounded-md text-gray-500 w-full"
                                    target="_blank"
                                    href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/app-notes.html">
                                    <div class="flex items-center gap-2">
                            ...
                            <li class="sidebar-item">
                                <a class="sidebar-link gap-3 py-2.5 my-1 text-base flex items-center justify-between relative rounded-md text-gray-500 w-full"
                                    target="_blank"
                                    href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/app-contact.html">
                                    <div class="flex items-center gap-2">
                            ...
                            <li class="sidebar-item">
                                <a class="sidebar-link gap-3 py-2.5 my-1 text-base flex items-center justify-between relative rounded-md text-gray-500 w-full"
                                    target="_blank"
                                    href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/app-contact2.html">
                                    <div class="flex items-center gap-2">
                            ...
                            <li class="sidebar-item">
                                <a class="sidebar-link gap-3 py-2.5 my-1 text-base flex items-center justify-between relative rounded-md text-gray-500 w-full"
                                    target="_blank"
                                    href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/app-invoice.html">
                                    <div class="flex items-center gap-2">
                            ...
                            <li class="sidebar-item">
                                <a class="sidebar-link gap-3 py-2.5 my-1 text-base flex items-center justify-between relative rounded-md text-gray-500 w-full"
                                    target="_blank"
                                    href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/page-pricing.html">
                                    <div class="flex items-center gap-2">
                            ...
                            <li class="sidebar-item">
                                <a class="sidebar-link gap-3 py-2.5 my-1 text-base flex items-center justify-between relative rounded-md text-gray-500 w-full"
                                    target="_blank"
                                    href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/page-faq.html">
                                    <div class="flex items-center gap-2">
                            ...
                            <li class="sidebar-item">
                                <a class="sidebar-link gap-3 py-2.5 my-1 text-base flex items-center justify-between relative rounded-md text-gray-500 w-full"
                                    target="_blank"
                                    href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/page-account-settings.html">
                                    <div class="flex items-center gap-2">
                            ...
                            <li class="sidebar-item">
                                <a class="sidebar-link gap-3 py-2.5 my-1 text-base flex items-center justify-between relative rounded-md text-gray-500 w-full"
                                    target="_blank"
                                    href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/landingpage/index.html">
                                    <div class="flex items-center gap-2">
                            ...
                            <div class="hs-accordion-group">
                                <div class="hs-accordion sidebar-item"
                                    ...
                                    <div id="hs-basic-with-title-and-arrow-stretched-collapse-widgets"
                                        ...
                                        <a class="gap-4 py-2.5 my-1 px-[14px] text-sm flex items-center justify-between relative  rounded-md text-gray-500  w-full"
                                            target="_blank"
                                            href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/widgets-cards.html">
                                            <div class="flex items-center gap-4">
                                        ...
                                        <a class="gap-4 py-2.5 my-1 px-[14px] text-sm flex items-center justify-between relative  rounded-md text-gray-500  w-full"
                                            target="_blank"
                                            href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/widgets-banners.html">
                                            <div class="flex items-center gap-4">
                                        ...
                                        <a class="gap-4 py-2.5 my-1 px-[14px] text-sm flex items-center justify-between relative  rounded-md text-gray-500  w-full"
                                            target="_blank"
                                            href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/widgets-charts.html">
                                            <div class="flex items-center gap-4">
                                        ...
                                        <a class="gap-4 py-2.5 my-1 px-[14px] text-sm flex items-center justify-between relative  rounded-md text-gray-500  w-full"
                                            target="_blank"
                                            href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/widgets-feeds.html">
                                            <div class="flex items-center gap-4">
                                        ...
                                        <a class="gap-4 py-2.5 my-1 px-[14px] text-sm flex items-center justify-between relative  rounded-md text-gray-500  w-full"
                                            target="_blank"
                                            href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/widgets-apps.html">
                                            <div class="flex items-center gap-4">
                                        ...
                                        <a class="gap-4 py-2.5 my-1 px-[14px] text-sm flex items-center justify-between relative  rounded-md text-gray-500  w-full"
                                            target="_blank"
                                            href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/widgets-data.html">
                                            <div class="flex items-center gap-4">
                            ...
                            <div class="hs-accordion-group">
                                <div class="hs-accordion sidebar-item"
                                    ...
                                    <div id="hs-basic-with-title-and-arrow-stretched-collapse-uielements"
                                        ...
                                        <a class="gap-4 py-2.5 my-1 px-[14px] text-sm flex items-center justify-between relative  rounded-md text-gray-500  w-full"
                                            target="_blank"
                                            href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/ui-accordion.html">
                                            <div class="flex items-center gap-4">
                                        ...
                                        <a class="gap-4 py-2.5 my-1 px-[14px] text-sm flex items-center justify-between relative  rounded-md text-gray-500  w-full"
                                            target="_blank"
                                            href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/ui-badge.html">
                                            <div class="flex items-center gap-4">
                                        ...
                                        <a class="gap-4 py-2.5 my-1 px-[14px] text-sm flex items-center justify-between relative  rounded-md text-gray-500  w-full"
                                            target="_blank"
                                            href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/ui-button.html">
                                            <div class="flex items-center gap-4">
                                        ...
                                        <a class="gap-4 py-2.5 my-1 px-[14px] text-sm flex items-center justify-between relative  rounded-md text-gray-500  w-full"
                                            target="_blank"
                                            href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/ui-breadcrumb.html">
                                            <div class="flex items-center gap-4">
                                        ...
                                        <a class="gap-4 py-2.5 my-1 px-[14px] text-sm flex items-center justify-between relative  rounded-md text-gray-500  w-full"
                                            target="_blank"
                                            href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/ui-carousel.html">
                                            <div class="flex items-center gap-4">
                                        ...
                                        <a class="gap-4 py-2.5 my-1 px-[14px] text-sm flex items-center justify-between relative  rounded-md text-gray-500  w-full"
                                            target="_blank"
                                            href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/ui-chat-bubbles.html">
                                            <div class="flex items-center gap-4">
                                        ...
                                        <a class="gap-4 py-2.5 my-1 px-[14px] text-sm flex items-center justify-between relative  rounded-md text-gray-500  w-full"
                                            target="_blank"
                                            href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/ui-dropdowns.html">
                                            <div class="flex items-center gap-4">
                                        ...
                                        <a class="gap-4 py-2.5 my-1 px-[14px] text-sm flex items-center justify-between relative  rounded-md text-gray-500  w-full"
                                            target="_blank"
                                            href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/ui-datepicker.html">
                                            <div class="flex items-center gap-4">
                                        ...
                                        <a class="gap-4 py-2.5 my-1 px-[14px] text-sm flex items-center justify-between relative  rounded-md text-gray-500  w-full"
                                            target="_blank"
                                            href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/ui-devices.html">
                                            <div class="flex items-center gap-4">
                                        ...
                                        <a class="gap-4 py-2.5 my-1 px-[14px] text-sm flex items-center justify-between relative  rounded-md text-gray-500  w-full"
                                            target="_blank"
                                            href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/ui-grid.html">
                                            <div class="flex items-center gap-4">
                                        ...
                                        <a class="gap-4 py-2.5 my-1 px-[14px] text-sm flex items-center justify-between relative  rounded-md text-gray-500  w-full"
                                            target="_blank"
                                            href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/ui-lists.html">
                                            <div class="flex items-center gap-4">
                                                <i class="ti ti-circle text-xs"></i> <span>List</span>
                                            </div>
                                            <span
                                        ...
                                        <a class="gap-4 py-2.5 my-1 px-[14px] text-sm flex items-center justify-between relative  rounded-md text-gray-500  w-full"
                                            target="_blank"
                                            href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/ui-link.html">
                                            <div class="flex items-center gap-4">
                                        ...
                                        <a class="gap-4 py-2.5 my-1 px-[14px] text-sm flex items-center justify-between relative  rounded-md text-gray-500  w-full"
                                            target="_blank"
                                            href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/ui-modals.html">
                                            <div class="flex items-center gap-4">
                                        ...
                                        <a class="gap-4 py-2.5 my-1 px-[14px] text-sm flex items-center justify-between relative  rounded-md text-gray-500  w-full"
                                            target="_blank"
                                            href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/ui-notification.html">
                                            <div class="flex items-center gap-4">
                                        ...
                                        <a class="gap-4 py-2.5 my-1 px-[14px] text-sm flex items-center justify-between relative  rounded-md text-gray-500  w-full"
                                            target="_blank"
                                            href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/ui-offcanvas.html">
                                            <div class="flex items-center gap-4">
                                        ...
                                        <a class="gap-4 py-2.5 my-1 px-[14px] text-sm flex items-center justify-between relative  rounded-md text-gray-500  w-full"
                                            target="_blank"
                                            href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/ui-progressbar.html">
                                            <div class="flex items-center gap-4">
                                        ...
                                        <a class="gap-4 py-2.5 my-1 px-[14px] text-sm flex items-center justify-between relative  rounded-md text-gray-500  w-full"
                                            target="_blank"
                                            href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/ui-pagination.html">
                                            <div class="flex items-center gap-4">
                                        ...
                                        <a class="gap-4 py-2.5 my-1 px-[14px] text-sm flex items-center justify-between relative  rounded-md text-gray-500  w-full"
                                            target="_blank"
                                            href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/ui-ratings.html">
                                            <div class="flex items-center gap-4">
                                        ...
                                        <a class="gap-4 py-2.5 my-1 px-[14px] text-sm flex items-center justify-between relative  rounded-md text-gray-500  w-full"
                                            target="_blank"
                                            href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/ui-scrollspy.html">
                                            <div class="flex items-center gap-4">
                                        ...
                                        <a class="gap-4 py-2.5 my-1 px-[14px] text-sm flex items-center justify-between relative  rounded-md text-gray-500  w-full"
                                            target="_blank"
                                            href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/ui-spinner.html">
                                            <div class="flex items-center gap-4">
                                        ...
                                        <a class="gap-4 py-2.5 my-1 px-[14px] text-sm flex items-center justify-between relative  rounded-md text-gray-500  w-full"
                                            target="_blank"
                                            href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/ui-stepper.html">
                                            <div class="flex items-center gap-4">
                                        ...
                                        <a class="gap-4 py-2.5 my-1 px-[14px] text-sm flex items-center justify-between relative  rounded-md text-gray-500  w-full"
                                            target="_blank"
                                            href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/ui-skeleton.html">
                                            <div class="flex items-center gap-4">
                                        ...
                                        <a class="gap-4 py-2.5 my-1 px-[14px] text-sm flex items-center justify-between relative  rounded-md text-gray-500  w-full"
                                            target="_blank"
                                            href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/ui-tab.html">
                                            <div class="flex items-center gap-4">
                                        ...
                                        <a class="gap-4 py-2.5 my-1 px-[14px] text-sm flex items-center justify-between relative  rounded-md text-gray-500  w-full"
                                            target="_blank"
                                            href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/ui-typography.html">
                                            <div class="flex items-center gap-4">
                                        ...
                                        <a class="gap-4 py-2.5 my-1 px-[14px] text-sm flex items-center justify-between relative  rounded-md text-gray-500  w-full"
                                            target="_blank"
                                            href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/ui-tooltip-popover.html">
                                            <div class="flex items-center gap-4">
                                        ...
                                        <a class="gap-4 py-2.5 my-1 px-[14px] text-sm flex items-center justify-between relative  rounded-md text-gray-500  w-full"
                                            target="_blank"
                                            href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/ui-timeline.html">
                                            <div class="flex items-center gap-4">
                                        ...
                                        <a class="gap-4 py-2.5 my-1 px-[14px] text-sm flex items-center justify-between relative  rounded-md text-gray-500  w-full"
                                            target="_blank"
                                            href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/ui-toasts.html">
                                            <div class="flex items-center gap-4">
                            ...
                            <div class="hs-accordion-group">
                                <div class="hs-accordion sidebar-item"
                                    ...
                                    <div id="hs-basic-with-title-and-arrow-stretched-collapse-cards"
                                        ...
                                        <a class="gap-4 py-2.5 my-1 px-[14px] text-sm flex items-center justify-between relative  rounded-md text-gray-500  w-full"
                                            target="_blank"
                                            href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/ui-cards.html">
                                            <div class="flex items-center gap-4">
                                        ...
                                        <a class="gap-4 py-2.5 my-1 px-[14px] text-sm flex items-center justify-between relative  rounded-md text-gray-500  w-full"
                                            target="_blank"
                                            href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/ui-card-customs.html">
                                            <div class="flex items-center gap-4">
                                        ...
                                        <a class="gap-4 py-2.5 my-1 px-[14px] text-sm flex items-center justify-between relative  rounded-md text-gray-500  w-full"
                                            target="_blank"
                                            href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/ui-card-weather.html">
                                            <div class="flex items-center gap-4">
                            ...
                            <div class="hs-accordion-group">
                                <div class="hs-accordion sidebar-item"
                                    ...
                                    <div id="hs-basic-with-title-and-arrow-stretched-collapse-formelements"
                                        ...
                                        <a class="gap-4 py-2.5 my-1 px-[14px] text-sm flex items-center justify-between relative  rounded-md text-gray-500  w-full"
                                            target="_blank"
                                            href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/form-inputs.html">
                                            <div class="flex items-center gap-4">
                                        ...
                                        <a class="gap-4 py-2.5 my-1 px-[14px] text-sm flex items-center justify-between relative  rounded-md text-gray-500  w-full"
                                            target="_blank"
                                            href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/form-input-groups.html">
                                            <div class="flex items-center gap-4">
                                        ...
                                        <a class="gap-4 py-2.5 my-1 px-[14px] text-sm flex items-center justify-between relative  rounded-md text-gray-500  w-full"
                                            target="_blank"
                                            href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/form-checkbox-radio.html">
                                            <div class="flex items-center gap-4">
                                        ...
                                        <a class="gap-4 py-2.5 my-1 px-[14px] text-sm flex items-center justify-between relative  rounded-md text-gray-500  w-full"
                                            target="_blank"
                                            href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/form-input-grid.html">
                                            <div class="flex items-center gap-4">
                                        ...
                                        <a class="gap-4 py-2.5 my-1 px-[14px] text-sm flex items-center justify-between relative  rounded-md text-gray-500  w-full"
                                            target="_blank"
                                            href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/form-input-number.html">
                                            <div class="flex items-center gap-4">
                                        ...
                                        <a class="gap-4 py-2.5 my-1 px-[14px] text-sm flex items-center justify-between relative  rounded-md text-gray-500  w-full"
                                            target="_blank"
                                            href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/form-advanced-password.html">
                                            <div class="flex items-center gap-4">
                            ...
                            <li class="sidebar-item">
                                <a class="sidebar-link gap-3 py-2.5 my-1 text-base flex items-center justify-between relative rounded-md text-gray-500 w-full"
                                    target="_blank"
                                    href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/table-basic.html">
                                    <div class="flex items-center gap-2">
                            ...
                            <li class="sidebar-item">
                                <a class="sidebar-link gap-3 py-2.5 my-1 text-base flex items-center justify-between relative rounded-md text-gray-500 w-full"
                                    target="_blank"
                                    href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/table-layout-highlighted.html">
                                    <div class="flex items-center gap-2">
                            ...
                            <li class="sidebar-item">
                                <a class="sidebar-link gap-3 py-2.5 my-1 text-base flex items-center justify-between relative rounded-md text-gray-500 w-full"
                                    target="_blank"
                                    href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/table-miscellaneous.html">
                                    <div class="flex items-center gap-2">
                            ...
                            <li class="sidebar-item">
                                <a class="sidebar-link gap-3 py-2.5 my-1 text-base flex items-center justify-between relative rounded-md text-gray-500 w-full"
                                    target="_blank"
                                    href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/table-editable.html">
                                    <div class="flex items-center gap-2">
                            ...
                            <li class="sidebar-item">
                                <a class="sidebar-link gap-3 py-2.5 my-1 text-base flex items-center justify-between relative rounded-md text-gray-500 w-full"
                                    target="_blank"
                                    href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/table-datatable-basic.html">
                                    <div class="flex items-center gap-2">
                                        <i class="ti ti-air-conditioning-disabled ps-2 text-2xl"></i>
                                        <span>Datatable</span>
                                    </div>
                                    <span
                                        class="text-white bg-blue-700 rounded-3xl px-2 text-xs py-0.5 mr-5">Pro</span>
                            ...
                            <div class="hs-accordion-group">
                                <div class="hs-accordion sidebar-item"
                                    ...
                                    <div id="hs-basic-with-title-and-arrow-stretched-collapse-apexcharts"
                                        ...
                                        <a class="gap-4 py-2.5 my-1 px-[14px] text-sm flex items-center justify-between relative  rounded-md text-gray-500  w-full"
                                            target="_blank"
                                            href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/chart-apex-line.html">
                                            <div class="flex items-center gap-4">
                                        ...
                                        <a class="gap-4 py-2.5 my-1 px-[14px] text-sm flex items-center justify-between relative  rounded-md text-gray-500  w-full"
                                            target="_blank"
                                            href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/chart-apex-area.html">
                                            <div class="flex items-center gap-4">
                                        ...
                                        <a class="gap-4 py-2.5 my-1 px-[14px] text-sm flex items-center justify-between relative  rounded-md text-gray-500  w-full"
                                            target="_blank"
                                            href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/chart-apex-bar.html">
                                            <div class="flex items-center gap-4">
                                        ...
                                        <a class="gap-4 py-2.5 my-1 px-[14px] text-sm flex items-center justify-between relative  rounded-md text-gray-500  w-full"
                                            target="_blank"
                                            href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/chart-apex-pie.html">
                                            <div class="flex items-center gap-4">
                                        ...
                                        <a class="gap-4 py-2.5 my-1 px-[14px] text-sm flex items-center justify-between relative  rounded-md text-gray-500  w-full"
                                            target="_blank"
                                            href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/chart-apex-radial.html">
                                            <div class="flex items-center gap-4">
                                        ...
                                        <a class="gap-4 py-2.5 my-1 px-[14px] text-sm flex items-center justify-between relative  rounded-md text-gray-500  w-full"
                                            target="_blank"
                                            href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/chart-apex-radar.html">
                                            <div class="flex items-center gap-4">
                            ...
                            <li class="sidebar-item">
                                <a class="sidebar-link gap-3 py-2.5 my-1 text-base flex items-center justify-between relative rounded-md text-gray-500 w-full"
                                    target="_blank"
                                    href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/authentication-error.html">
                                    <div class="flex items-center gap-2">
                            ...
                            <li class="sidebar-item">
                                <a class="sidebar-link gap-3 py-2.5 my-1 text-base flex items-center justify-between relative rounded-md text-gray-500 w-full"
                                    target="_blank"
                                    href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/authentication-login.html">
                                    <div class="flex items-center gap-2">
                            ...
                            <li class="sidebar-item">
                                <a class="sidebar-link gap-3 py-2.5 my-1 text-base flex items-center justify-between relative rounded-md text-gray-500 w-full"
                                    target="_blank"
                                    href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/authentication-register.html">
                                    <div class="flex items-center gap-2">
                            ...
                            <div class="hs-accordion-group">
                                <div class="hs-accordion sidebar-item"
                                    ...
                                    <div id="hs-basic-with-title-and-arrow-stretched-collapse-forgotpassword"
                                        ...
                                        <a class="gap-4 py-2.5 my-1 px-[14px] text-sm flex items-center justify-between relative  rounded-md text-gray-500  w-full"
                                            target="_blank"
                                            href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/authentication-forgot-password.html">
                                            <div class="flex items-center gap-4">
                                        ...
                                        <a class="gap-4 py-2.5 my-1 px-[14px] text-sm flex items-center justify-between relative  rounded-md text-gray-500  w-full"
                                            target="_blank"
                                            href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/authentication-forgot-password2.html">
                                            <div class="flex items-center gap-4">
                            ...
                            <div class="hs-accordion-group">
                                <div class="hs-accordion sidebar-item"
                                    ...
                                    <div id="hs-basic-with-title-and-arrow-stretched-collapse-twosteps"
                                        ...
                                        <a class="gap-4 py-2.5 my-1 px-[14px] text-sm flex items-center justify-between relative  rounded-md text-gray-500  w-full"
                                            target="_blank"
                                            href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/authentication-two-steps.html">
                                            <div class="flex items-center gap-4">
                                        ...
                                        <a class="gap-4 py-2.5 my-1 px-[14px] text-sm flex items-center justify-between relative  rounded-md text-gray-500  w-full"
                                            target="_blank"
                                            href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/authentication-two-steps2.html">
                                            <div class="flex items-center gap-4">
                            ...
                            <li class="sidebar-item">
                                <a class="sidebar-link gap-3 py-2.5 my-1 text-base flex items-center justify-between relative rounded-md text-gray-500 w-full"
                                    target="_blank"
                                    href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/authentication-maintenance.html">
                                    <div class="flex items-center gap-2">
                            ...
                            <li class="sidebar-item">
                                <a class="sidebar-link gap-3 py-2.5 my-1 text-base flex items-center justify-between relative rounded-md text-gray-500 w-full"
                                    target="_blank"
                                    href="https://bootstrapdemos.wrappixel.com/spike-tailwind/dist/main/icon-solar.html">
                                    <div class="flex items-center gap-2">
                ...
                <div class="m-4 relative grid">
                    <a href="https://www.wrappixel.com/templates/spike-tailwind-admin-template/?ref=376"
                        target="_blank" class="text-base font-semibold hover:bg-blue-700 btn">Upgrade to Pro</a>
                </div>
                <!-- </aside> -->
            </aside>
                            ...
                            <nav class=" w-ful flex items-center justify-between" aria-label="Global">
                                ...
                                <div class="flex items-center gap-4">
                                    <a href="https://www.wrappixel.com/templates/spike-free-tailwind-admin-template/"
                                        class="btn text-base font-medium hover:bg-blue-700" target="_blank"
