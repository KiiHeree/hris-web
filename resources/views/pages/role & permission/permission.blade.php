...
<div>
    <div class="az-content-body pd-lg-l-40 d-flex flex-column">
        ...
        @endif
        <div class="az-content-label mg-b-5">Permission</div>
        <p class="mg-b-5">This menu is used to manage list of permission in the company.</p>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-capitalize" id="exampleModalLongTitle">{{ $mode }} Permission
                    </h5>
